...
export default function Home() {
  ...
  const handleExtractRequirements = async () => {
    ...
    try {
      setExtracting(true);
      setExtractProgress('Sending document to AI...');
      showBanner('success', 'Extracting RFP requirements via local AI — this takes 1-3 minutes for large PDFs...');

      const messages = [
        'Analyzing document chunks...',
        'Extracting requirements...',
        'Extracting deadlines & budgets...',
        'Extracting eligibility criteria...',
        'Almost done, deduplicating results...',
      ];
      let msgIdx = 0;
      const progressTimer = setInterval(() => {
        msgIdx = (msgIdx + 1) % messages.length;
        setExtractProgress(messages[msgIdx]);
      }, 8000);
